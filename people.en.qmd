...
## Technical, managerial and research team
...
Dr. Rosie Howard is a data scientist for the CARBONIQUE project. She has worked as a Research Associate and leader in research and development strategies for over a decade, on a variety of research topics spanning numerical weather prediction and meteorology across multiple scales. Her focus shifted to climate science when she joined the EcoFlux Lab at McGill University in March 2024. Currently, she is working on standardizing eddy-covariance data from flux towers in Canadian wetlands, including CARBONIQUE sites, with the larger goal of evaluating the role of wetlands as a natural climate solution.
...
-----|:-----
Name| Hongxing He
Email| hongxing.he\@mcgill.ca
<!--Office| MCML 137-->

:::
::::
 
Dr. Hongxing He is a Research Associate in the Department of Geography at McGill University. His research focuses on developing and applying process-based ecosystem models to simulate greenhouse gas (CO₂, CH₄, and N₂O) exchanges and dissolved organic carbon (DOC) dynamics, along with the environmental factors that regulate these processes across wetland ecosystems. His modelling aims to improve process-level understanding of wetland carbon cycling and to evaluate how changes in climate and management influence key components of the carbon budget within the CARBONIQUE project.
...
Dr. Joyson Ahongshangbam is a Research Associate in the Department of Geography at McGill University. His research focuses on greenhouse gas (CO₂ and CH₄) and water fluxes across diverse ecosystems, including forests, urban vegetation, and wetlands, using eddy covariance, sap flow measurements, remote sensing, and ecosystem modeling. In the CARBONIQUE project, he aims to compare the net atmospheric carbon (C) and greenhouse gas (GHG) budgets across different wetland types and assess the environmental and biophysical drivers controlling vertical carbon and greenhouse gas fluxes.
