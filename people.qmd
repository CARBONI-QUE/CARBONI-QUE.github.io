...
|
-----|:-----
Nom| Dr. Scott J. Davidson
Courriel| davidson.scott_j\@uqam.ca
<!--Office| PCMH B1100-->
...
-----|:-----
Nom| Rosemary Howard
Courriel| rosemary.howard\@mcgill.ca
<!--Office| MCML 137-->

::: 
::::

Rosie Howard est data scientist pour le projet CARBONIQUE. Elle a travaillé pendant plus de dix ans en tant qu'associée de recherche et responsable de stratégies de recherche et développement, abordant divers sujets allant de la prévision numérique du temps à la météorologie à différentes échelles. Elle a orienté ses travaux vers la science du climat en rejoignant l'EcoFlux Lab de l'Université McGill en mars 2024. Actuellement, elle travaille à la normalisation des données de corrélation des turbulences (eddy-covariance) provenant de tours de mesure de flux situées dans des milieux humides canadiennes — y compris les sites du projet CARBONIQUE — avec pour objectif global d'évaluer le rôle de ces écosystèmes en tant que solution climatique fondée sur la nature.
...
-----|:-----
Nom| Hongxing He
Courriel| hongxing.he\@mcgill.ca
<!--Office| MCML 137-->

:::
::::

Hongxing He est chercheur associé au Département de géographie de l'Université McGill. Ses travaux de recherche portent sur le développement et l'application de modèles écosystémiques fondés sur les processus pour simuler les échanges de gaz à effet de serre (CO₂, CH₄ et N₂O) et la dynamique du carbone organique dissous (COD), ainsi que les facteurs environnementaux régissant ces processus dans les écosystèmes de milieux humides. Ses activités de modélisation visent à approfondir la compréhension des processus liés au cycle du carbone dans les milieux humides et à évaluer l'incidence des changements climatiques et des pratiques de gestion sur les composantes clés du bilan carbone, dans le cadre du projet CARBONIQUE.
...
![](images/team/ahongshangbam_joyson.jpg)
...
::: {.column width="50%"}
 ...
 |
-----|:-----
Nom| Joyson Ahongshangbam
Courriel| joyson.ahongshangbam\@mcgill.ca
<!--Office| MCML 137-->

:::
::::

Joyson Ahongshangbam est chercheur associé au Département de géographie de l'Université McGill. Ses recherches portent sur les flux de gaz à effet de serre (CO₂ et CH₄) et d'eau dans divers écosystèmes — notamment les forêts, la végétation urbaine et les milieux humides — en s'appuyant sur la méthode de corrélation des turbulences (eddy covariance), la mesure du flux de sève, la télédétection et la modélisation des écosystèmes. Dans le cadre du projet CARBONIQUE, il vise à comparer les bilans nets de carbone (C) et de gaz à effet de serre (GES) atmosphériques entre différents types de milieux humides, ainsi qu'à évaluer les facteurs environnementaux et biophysiques régissant les flux verticaux de carbone et de gaz à effet de serre.
...
![](images/team/isabelle_jacob.jpeg)

:::
::: {.column width="50%"}

**Dylan Gwilliam (McGill)**
: *(Maitrise en géographie)*

![](images/team/gwilliam_dylan.jpg)
...
:::: {layout-nrow=1}
::: {.column width="50%"}
**Sidonie Phouttama (ULaval)**
: *(Maitrise en sciences géographiques)*

![](images/team/phouttama_sidonie.jpg)

:::
::: {.column width="50%"}

**Jeri Rabearison (UQTR)**
: *(Stagiaire postdoctoral)*

![](images/team/rabearison_jeri.jpeg)
...
![](images/team/racine_erika.jpg)

:::
::: {.column width="50%"}

**Jeanne Renauld (ULaval)**
: *(Maitrise en sciences géographiques)*

![](images/team/renauld_jeanne.jpg)
...
![](images/team/couillard_maya.jpg)
